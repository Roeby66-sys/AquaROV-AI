...
class MainWindow(QMainWindow):
    ...
    This class coordinates DTOs, camera/inference services, and Qt UI.
    """
    ...
    def _configure_cameras(self) -> None:
        """Create video views for enabled camera channels."""

        for index, channel in enumerate(
            channel
            for channel in self.config.camera_config.channels
            if channel.enabled
        ):
    ...
    def _add_video_view(
        ...
        """Create and register a video view for one camera."""
    ...
    def _handle_camera_frame(
        ...
        """Forward camera frames safely to the Qt GUI thread."""
    ...
    def _handle_camera_error(
        ...
        """Forward camera errors to the Qt GUI thread."""
    ...
    def _handle_inference_result(
        ...
        """Convert inference output into the shared DetectionSet DTO."""
    ...
    def _handle_inference_error(
        ...
        """Forward inference errors to the Qt GUI thread."""
    ...
    def _on_frame_ready(
        ...
        """Update the corresponding video view."""
    ...
    def _on_detection_ready(
        ...
        """Update detection overlays from a DetectionSet."""
    ...
    def _on_inference_error(
        ...
        """Display an inference error in the system status."""
    ...
    def _on_camera_error(
        ...
        """Display a camera error and disconnect its video view."""
    ...
    def _on_tile_activated(
        ...
        """Show which camera tile is currently focused."""
...
__all__ = ["MainWindow"]    def _build_ui(self) -> None:
        self.setWindowTitle(
            f"{self.config.application_name} — Operator Console"
        )
        self.resize(1280, 800)
